...
public class MainActivity extends AppCompatActivity {
    ...
    private final int[] aroundCircleTitleEn = {R.string.topTitleEn, R.string.topRightTitleEn, R.string.topLeftTitleEn, R.string.rightTitleEn, R.string.leftTitleEn, R.string.bottomRightTitleEn};
    private final int[] aroundCircleTitleCn = {R.string.topTitleCn, R.string.topRightTitleCn, R.string.topLeftTitleCn, R.string.rightTitleCn, R.string.leftTitleCn, R.string.bottomRightTitleCn};


    private final int[] circleIcon = {R.drawable.bt1, R.drawable.bt2, R.drawable.bt33, R.drawable.bt4, R.drawable.bt5, R.drawable.bt66};
    private final int[] circleCompleteStatusList = {AttrEntity.DEF,
            AttrEntity.DEF,
            AttrEntity.DEF,
            AttrEntity.DEF,
            AttrEntity.DEF,
