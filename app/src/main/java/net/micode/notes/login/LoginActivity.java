...
import net.micode.notes.menu.MainActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        params3 = new FrameLayout.LayoutParams(inDp(), inDp());
        ...
        relativeLayout.post(new Runnable() {
            ...
            public void run() {
                ...
                logo.setX((float)(relativeLayout2.getRight() / 2));
                logo.setY(inDp());
        ...
        signUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (params.weight == 4.25) {//从这里开始写
                    if(!confirmPass.getText().toString().equals(pass2.getText().toString())){
                ...
                bounds.addListener(new Transition.TransitionListener() {
                    ...
                    public void onTransitionStart(Transition transition) {
                        ...
                        ObjectAnimator animator1 = ObjectAnimator.ofFloat(signUp, "translationX", (float)(mainLinear.getWidth() / 2 - relativeLayout2.getWidth() / 2 - signUp.getWidth() / 2));
                        ...
                        ObjectAnimator animator8 = ObjectAnimator.ofFloat(login, "y", (float)(relativeLayout2.getHeight() / 2)) ;
                        ...
                        ObjectAnimator animator18 = ObjectAnimator.ofFloat(logo, "x", (float)( relativeLayout2.getRight() / 2 - relativeLayout.getRight()));
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (params2.weight == 4.25) {
                    ...
                    if(email.getText().toString().equals("123456@qq.com")&&pass.getText().toString().equals("123456")) {
                        //登录界面
                        //Snackbar.make(relativeLayout, "登录成功！", Snackbar.LENGTH_SHORT).show();
                        Intent intent = new Intent(view.getContext(), MainActivity.class);
                        startActivityForResult(intent,0);
                    }
                    else {
                        Snackbar.make(relativeLayout, "密码错误！", Snackbar.LENGTH_SHORT).show();
                    }
                }
                else {
    ...
    private int inDp() {
        ...
        return (int) (50 * ((float) metrics.densityDpi / DisplayMetrics.DENSITY_DEFAULT));
    }
}